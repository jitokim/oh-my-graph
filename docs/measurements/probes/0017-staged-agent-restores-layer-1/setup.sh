...
#                                           SKILL.md" is what several arms
#                                           measure
#   <ws>/repo/.claude/agents/omg-probe-writer.md
#                                           agentmap's match source, and what
#                                           --agent resolves TODAY
...
#   <ws>/run/skills-plugin/                 what the code REALLY materializes
#   <ws>/run/skills-plugin-agents/          THE CANDIDATE: the same directory
#                                           plus agents/, built by stage.sh
...
# The candidate directory. Built AFTER the harness, because it is a copy of
# what the harness materialized.
bash "$HERE/stage.sh" "$WS" plain
